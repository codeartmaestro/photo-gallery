...
!(function(e) {
  ...
  var m = a.MutationObserver || a.WebKitMutationObserver || !1,
    ...
    b = function(e, p) {
      ...
      var T = this;
      (this.version = "3.7.4"), (this.name = "nicescroll"), (this.me = p);
      var E = n("body"),
      ...
      (this.rail = !1),
        ...
        (this.lastdeltay = 0),
        (this.detected = w());
      var N = n.extend({}, this.detected);
      (this.canhwscroll = N.hastransform && M.hwacceleration),
        (this.ishwscroll = this.canhwscroll && T.haswrapper),
        this.isrtlmode
          ? this.isvertical
            ? (this.hasreversehr = !(N.iswebkit || N.isie || N.isie11))
            : (this.hasreversehr = !(
                N.iswebkit ||
                (N.isie && !N.isie10 && !N.isie11)
              ))
          : (this.hasreversehr = !1),
        (this.istouchcapable = !1),
        N.cantouch || (!N.hasw3ctouch && !N.hasmstouch)
          ? !N.cantouch ||
            N.isios ||
            N.isandroid ||
            (!N.iswebkit && !N.ismozilla) ||
            (this.istouchcapable = !0)
          : (this.istouchcapable = !0),
        M.enablemouselockapi ||
          ((N.hasmousecapture = !1), (N.haspointerlock = !1)),
      ...
      if (
        ...
        N.hastranslate3d && M.enabletranslate3d
      ...
      (this.getDocumentScrollOffset = function() {
        ...
        (this.init = function() {
          ...
          if (
            ((N.isie11 || N.isie10) && (e["-ms-overflow-style"] = "none"),
            T.ishwscroll &&
              (this.doc.css(
                N.transitionstyle,
                N.prefixstyle + "transform 0ms ease-out"
              ),
              N.transitionend &&
                T.bind(T.doc, N.transitionend, T.onScrollTransitionEnd, !1)),
            (T.zindex = "auto"),
            ...
            T.ispage && (i = T.haswrapper ? T.win : T.doc),
              T.css(i, e),
              T.ispage && (N.isie11 || N.isie) && T.css(n("html"), e),
              !N.isios ||
                T.ispage ||
                T.haswrapper ||
            ...
            if (
              (M.horizrailenabled &&
                ...
                N.isieold && d.css("overflow", "hidden"),
                d.addClass("nicescroll-cursors"),
                (T.cursorh = d),
              ...
              N.isios &&
                ...
                M.disableoutline &&
                  (N.isie && T.win.attr("hideFocus", "true"),
                  N.iswebkit && T.win.css("outline", "none"));
            }
            if (
              (!1 === M.autohidemode
                ? ((T.autohidedom = !1),
                ...
                ? ((T.autohidedom = n().add(T.rail)),
                  N.isie8 && (T.autohidedom = T.autohidedom.add(T.cursor)),
              ...
              N.cantouch || T.istouchcapable || M.emulatetouch || N.hasmstouch)
            ) {
              T.scrollmom = new y(T);
              (T.ontouchstart = function(e) {
                ...
                if (
                  ...
                  if (M.emulatetouch && T.isiframe && N.isie) {
                  ...
                  if (
                    ...
                    if (!/INPUT|SELECT|BUTTON|TEXTAREA/i.test(o.nodeName))
                      return (
                        N.hasmousecapture && o.setCapture(),
                        M.emulatetouch
                          ? (o.onclick &&
                              !o._onclick &&
                ...
                (T.ontouchend = function(e) {
                  ...
                  if (2 == T.rail.drag.pt) {
                    ...
                    if (
                      ...
                      (T.lastmouseup = !0),
                      T.hideCursor(),
                      N.hasmousecapture && l.releaseCapture(),
                      o)
                    )
                      return T.cancelEvent(e);
                  } else if (1 == T.rail.drag.pt) return T.onmouseup(e);
                });
              var z = M.emulatetouch && T.isiframe && !N.hasmousecapture,
              ...
              (T.ontouchmove = function(e, o) {
                ...
                (T.ontouchstartCursor = function(e, o) {
                  if (!T.rail.drag || 3 == T.rail.drag.pt) {
                    ...
                    var t = T.getTarget(e);
                    return (
                      !T.ispage && N.hasmousecapture && t.setCapture(),
                      T.isiframe &&
                        !N.hasmousecapture &&
            ...
            if (
              ((T.onmousedown = function(e, o) {
                if (!T.rail.drag || 1 == T.rail.drag.pt) {
                  ...
                  var t = T.getTarget(e);
                  return (
                    N.hasmousecapture && t.setCapture(),
                    T.isiframe &&
                      !N.hasmousecapture &&
              ...
              (T.onmousemove = function(e) {
                if (T.rail.drag) {
                  ...
                  if (N.ischrome && 0 === e.which) return T.onmouseup(e);
                  if (
                    ((T.cursorfreezed = !0),
                    T.hasmoving ||
                      T.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0),
              ...
              (T.onpreventclick = function(e) {
                ...
                M.grabcursorenabled &&
                  ...
                  (T.css(T.ispage ? T.doc : T.win, {
                    cursor: N.cursorgrabvalue
                  }),
                  T.css(T.rail, { cursor: N.cursorgrabvalue }));
            else {
              var L = function(e) {
                if (T.selectiondrag) {
                  if (e) {
            ...
            if (
              ...
              (M.cursordragontouch || (!N.cantouch && !M.emulatetouch)) &&
              ...
              M.cursordragontouch &&
                (this.istouchcapable || N.cantouch) &&
              ...
              M.enablemousewheel &&
                (T.isiframe ||
                  T.mousewheel(N.isie && T.ispage ? l : T.win, T.onmousewheel),
              ...
              M.enablekeyboard &&
                T.bind(
                  l,
                  N.isopera && !N.isopera12 ? "keypress" : "keydown",
                  T.onkeypress
                ),
              ...
              N.ischrome && !T.ispage && !T.haswrapper)
            ) {
                ...
                T.ispage ||
                  ...
                  (!1 !== m
                    ...
                    : (T.bind(
                      ...
                      T.bind(T.win, "DOMNodeRemoved", function(e) {
          ...
          if ("IFRAME" == this.doc[0].nodeName) {
            var R = function() {
              ...
              if (
                ...
                !N.isios && M.iframeautoresize && !T.isiframe)
              ) {
              ...
              T.lazyResize(30),
                ...
                M.enablekeyboard &&
                  T.bind(o, N.isopera ? "keypress" : "keydown", T.onkeypress),
                N.cantouch
                  ...
                  : M.emulatetouch &&
                    ...
                    M.grabcursorenabled &&
                      N.cursorgrabvalue &&
                      T.css(n(o.body), { cursor: N.cursorgrabvalue })),
          ...
          return (
            ...
            T.railslocked
              ...
              : (T.hidden || T.visibility
                  ? !T.railh || T.hidden || T.railh.visibility || T.showRailHr()
          ...
          if (s)
            for (var n = 0, l = s.l.length; n < l; n++)
              s.a[n] === T.id &&
                (s.a.splice(n),
                s.l.splice(n),
                0 === s.a.length && (T._unbind(e, o, del.f), (d[o] = null)));
        }),
      ...
      if (
        ...
        if (
          ...
          (this.resetTransition = function() {
            (j = ""), T.doc.css(N.prefixstyle + "transition-duration", "0ms");
          }),
            (this.prepareTransition = function(e, o) {
              ...
              return (
                j !== r &&
                  ((j = r),
                  T.doc.css(N.prefixstyle + "transition-duration", r)),
                t
              );
            }),
            ...
            (this.cancelScroll = function() {
              ...
              return (
                (T.scrollrunning = !1),
                N.transitionend || clearTimeout(N.transitionend),
        ...
        (this.doZoomOut = function(e) {
          if (T.zoomactive)
            return (
              ...
              N.isios4 && c.scrollTop(T.zoomrestore.scrollTop),
